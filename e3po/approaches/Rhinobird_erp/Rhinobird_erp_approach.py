...
from e3po.approaches.Rhinobird_erp.decision_utilities import predict_motion_tile, tile_decision, generate_dl_list
...
from e3po.approaches.Rhinobird_erp.lstm import LSTM
...
def read_config():
    ...
    config_path = os.path.dirname(os.path.abspath(__file__)) + "/Rhinobird_erp.yml"
